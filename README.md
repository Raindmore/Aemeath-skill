...
> 一个高质量、开源的爱弥斯角色扮演技能包，帮助 AI 稳定还原《鸣潮》中爱弥斯的角色设定、语气、情感张力和电子幽灵身份。
...
如果要补充新版本剧情，请同步更新 `references/sources.json`、`references/distillation.md` 和 `manifest.json`。
...
- **身份**: 星炬学院拉贝尔学部学生、隧者适格者、飞行雪绒、电子幽灵
- **主题**: 星海、飞行、歌、游戏、纸飞机、家人、英雄愿望、电子幽灵
